...
private:
    ...
    void createFramebuffers()
    {
        ...
        std::cout << swapChainFramebuffers.size() << std::endl;
    ...
    VkShaderModule createShaderModule(const std::vector<char> &code)
    {
        ...
        createInfoShaderModule.codeSize = code.size();
        createInfoShaderModule.pCode = reinterpret_cast<const uint32_t *>(code.data());
        VkShaderModule shaderModule;
        if (vkCreateShaderModule(device, &createInfoShaderModule, nullptr, &shaderModule) != VK_SUCCESS) {
    ...
    {
        std::vector<char> vertShaderCode = readFile("/home/slavko/Projects/diplom/GameEngine/SynthGameEngine/GameEngine/source/shaders/vert.spv");
        std::vector<char> fragShaderCode = readFile("/home/slavko/Projects/diplom/GameEngine/SynthGameEngine/GameEngine/source/shaders/frag.spv");
    ...
    void setubDebugMessenger()
    {
        ...
        else 
        {
            ...
            populateDebugMessengerCreateInfo(createInfoDebug);

            if(CreateDebugUtilsMessengerEXT(instance, &createInfoDebug, nullptr, &debugMessanger) != VK_SUCCESS)
            {
    ...
    void createInstance()
    {
        ...
        {
            std::cout << "Instance was created success" << std::endl;
        }
        else
        {
            throw std::runtime_error("instance wasn't created");
        }
    }
    ...
    void initWindow()
    {
        ...
        window = SDL_CreateWindow("Vulkan", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WIDTH_SCREEN, HEIGHT_SCREEN, SDL_WINDOW_VULKAN);
...
const std::string MODEL_PATH = "/home/slavko/Projects/VulkanTutorial/resources/simplePlane.obj";
const std::string TEXTURE_PATH = "/home/slavko/Projects/VulkanTutorial/resources/textureGray.png";

const std::string ak47_path = "/home/slavko/Projects/VulkanTutorial/resources/AK47/scenes/AK47.obj";
const std::string ak47_path_texture = "/home/slavko/Projects/VulkanTutorial/resources/AK47/sourceimages/2nd Texture/color.tga";
...
Camera camera(glm::vec3(0.183165, -0.0376139, 5.031249), glm::vec3(0.f, 1.0f, 0.f), 243.051, -20.7);
...
private:
    ...
    void initVulkan() {
        ...
        createTextureImage(ak47_path_texture);
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("/home/slavko/Projects/diplom/GameEngine/SynthGameEngine/GameEngine/source/shaders/vert.spv");
        auto fragShaderCode = readFile("/home/slavko/Projects/diplom/GameEngine/SynthGameEngine/GameEngine/source/shaders/frag.spv");
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.model = glm::scale(glm::mat4(1.0f), glm::vec3(0.1f, 0.1f, 0.1f));//glm::rotate(glm::mat4(1.0f), time * glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.view = camera.GetViewMatrix();//glm::lookAt(camera.Frontglm::vec3(2.0f, 2.0f, 2.0f),  glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.proj = camera.GetProjectionMatrix();//glm::perspective(glm::radians(45.0f), swapChainExtent.width / (float) swapChainExtent.height, 0.1f, 10.0f);
        ubo.proj[1][1] *= -1;
